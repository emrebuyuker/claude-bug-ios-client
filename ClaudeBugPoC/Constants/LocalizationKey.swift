...
enum LocalizationKey {
    ...
    enum View {
        ...
        enum FigmaCompare {
            ...
            static let pickImageButton = "figmaCompare.button.pickImage"
            static let pickImageSheetTitle = "figmaCompare.pickImage.sheetTitle"
            static let pickImagePhotos = "figmaCompare.pickImage.photos"
            static let pickImageFiles = "figmaCompare.pickImage.files"
            static let imageReadError = "figmaCompare.error.imageRead"
